    ...
    <div className="overflow-y-auto w-full scroll-container     lg:w-[300px]  lg:h-[540px] overflow-x-auto cursor-default py-1  shadow-lg rounded-md">
      <div className=" px-1 flex lg:flex-col gap-2 lg:gap-5 w-full ">
        {cards.map((card) => (
          ...
          key={card.id}
          className="bg-[#ffffff] hover:bg-[#e5e5e5] transition-all ease-out duration-700  hover:dark:bg-[#353535] dark:bg-[#282828] shadow-lg h-[290px] lg:h-auto lg:mx-auto text-sm rounded-md lg:w-72 w-60 p-4 flex-shrink-0 hover:shadow-lg  group"
        >
          <div className="h-[50%] ">
            <img
